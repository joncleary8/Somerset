...
public class Introduction
	{
		...
		public static void introduce()
		{
			...
			playerList.add(new Player(playerOneName, 1, 0, 0));
			...
			playerList.add(new Player(playerTwoName, 2, 0, 0));
			...
			playerList.add(new Player(playerThreeName, 3, 0 ,0));
			...
			playerList.add(new Player(playerFourName, 4, 0, 0));
